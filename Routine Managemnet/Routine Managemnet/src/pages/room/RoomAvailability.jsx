...
const RoomAvailability = () => {
  ...
  const handleSubmit = async () => {
      ...
      if (day !== null && slot !== null) {
          try {
            ...
            const response = await axios.get(`http://localhost:3000/api/room/available/${day}/${slot}`);
        ...
        // setRooms(data.rooms || []); // Assuming API returns an object with a "rooms" array
      } catch (error) {
  ...
  return (
      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-80 mb-8">
        <h1 className="text-2xl font-bold text-center text-blue-800 mb-4">Select Day & Slot</h1>

        {/* Dropdown for Day Selection */}
        <div className="mb-4">
          <label htmlFor="day" className="block text-gray-700 mb-2 font-semibold">Day</label>
          <select
            id="day"
            value={day !== null ? day : ""}
        ...
        <div className="mb-4">
          <label htmlFor="slot" className="block text-gray-700 mb-2 font-semibold">Slot</label>
          <select
            id="slot"
            ...
            <table className="table-auto w-full text-left border-collapse">
              <thead className="bg-orange-600 text-white">
                <tr>
                  ...
                  {/* <th className="p-4 border border-black">Capacity</th> */}
                  {/* <th className="p-4 border border-black">Features</th> */}
                </tr>
              </thead>
              <tbody>
